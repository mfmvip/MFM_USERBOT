...
ALIVE_NAME = Config.ALIVE_NAME if Config.ALIVE_NAME else "@MFMVIP"
...
# for alive
Def = str(ALIVE_NAME) if ALIVE_NAME else "MFM - User"
asst_p = "https://telegra.ph/file/967209504b62689f5f770.jpg"
asst_c = "➥ **ASSISTANT IS:** `ONLINE`\n"
asst_c += f"➥ **My Boss** : {Def} \n"
asst_c += "➥ **Heroku Database** : `AWS - Working Properly`\n"
asst_c += "➥ **Copyright** : By [𝙈𝙐𝙎𝙏𝘼𝙁𝘼](https://github.com/MFMVIP)\n"
asst_c += "[𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤](https://t.me/TOKYO_TEAM)"
...
# Set MFM-Bot in @botfather
SetMsg = [
    "✘ ∫ يتم تنصيب بوتك في @botfather",
    "✘ ∫ يتم اكمال تنصيب بوتك في @BotFather",
    "✘ ∫ تم تنصيب بوتك"
]
SetDec = "- 𝙏𝙤𝙠𝙔𝙤 𝘼𝙎𝙎𝙄𝙎𝙏𝘼𝙉𝙏 𝘽𝙊𝙏 🔱\n- 𝙈𝙁𝙈 𝘽𝙊𝙏 𝙁𝙊𝙍 ~ {}\n- 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝙀𝙑 ~ @MFMVIP 𖤨"
SetAbt = "- 𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤 🔱\n- 𝙈𝙁𝙈 𝘽𝙊𝙏 𝙁𝙊𝙍 ~ {}"

# This is For MFM - Userbot only!!
