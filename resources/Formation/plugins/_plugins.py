...
# بلاي 
R = (
    "**𓆰**  𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤   **العـاب الاونلايـن** 🎮𓆪 \n"
    "◐━─━─━─━─𝙕𝞝𝘿─━─━─━─━◐\n\n"
    ...
    "**𓄂-** 𝙎𝙤𝙪𝙧𝙘𝙚 𝘿𝙀𝙑 **⪼**  [𝙈𝙐𝙎𝙏𝘼𝙁𝘼](t.me/MFMVIP)   \n"
    "**𓆰** 𝙎𝙤𝙪𝙧𝙘𝙚 𝙍𝙀𝙋𝙊 **⪼**  [𝙏𝙤𝙠𝙔𝙤](https://t.me/TOKYO_TEAM/102)  "
)
K = "https://github.com/MFMVIP/MFM_USERBOT"

# Alive Bot 
TOSH = (
       f"**✘ ∫ بوت طوكيو يعمل بنجاح 🖤❕**\n"
