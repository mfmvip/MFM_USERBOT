...
DEFAULTUSER = str(Name) if Name else "MFM VIP"
...
"""       ⫷ بوت طوكيو  يعمل بنجاح الان ⫸
   ⫷ المستخدم: {} - البوت: {} ⫸
⫷ @TOKYO_TEAM - اذا كنت بحاجه الى مساعده فتوجه الى ⫸"""
)
