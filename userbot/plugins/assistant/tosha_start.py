...
# =================== OWNER - MFMVIP =================== #
ALIVE_NAME = Config.ALIVE_NAME if Config.ALIVE_NAME else "@TOKYO_TEAM"
...
async def logs(event):
    ...
    await tgbot.send_file(
        ...
        buttons=[
            ...
            [Button.url("💠 𝘾𝙍𝘼𝙎𝙃𝙀𝘿 💠", "t.me/TOKYO_TEAM")]
        ])
...
async def settings(event):
    ...
    await tgbot.send_message(event.chat_id,
                             ...
                             buttons=[
                                     [Button.inline(
                                         "⚜️ احصل على بوت طوكيو بنفسك ⚜️", data="deployme")]
                             ])
...
async def settings(event):
    await event.delete()
    await event.reply(f"✘ ∫ انا طوكيو مساعد {mention}. الشخصي تستطيع الاتصال بي عن طريق هذا البوت",
                             buttons=[
                                     [Button.inline(
                                         "⚜️ حصل على بوت طوكيو بنفسك ⚜️", data="deployme")]
                             ])
...
async def settings(event):
    await event.edit("** ✘ ∫ هنا ستجد رابط طوكيو ورابط التنصيب ايضا**:",
                     buttons=[
                         [Button.url("🔗 رابط السورس🔗", url="https://github.com/TOKYO_TEAM/MFMpack")],
                         [Button.url("🔗 رابط التنصيب 🔗", url="https://dashboard.heroku.com/new?template=https://github.com/TOKYO_TEAM/MFMpack/")],
                         [Button.url("✨ الدعم ✨",
                                     url="https://t.me/TOKYO_TEAM")]
                     ])
...
async def settings(event):
    if event.sender_id == OWNER_ID:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @TOKYO_TEAM", alert=True)
