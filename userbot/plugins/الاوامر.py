...
########################  𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤 ~ BY: 𝙈𝙐𝙎𝙏𝘼𝙁𝘼 (@TOKYO_TEAM)  ########################
...
async def _(MFM):
    await eor(MFM, "𓆰 [𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/TOKYO_TEAM) 𓆪\n **✘ ∫ قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤](t.me/TOKYO_TEAM) 𓆪")

########################  SOURCE ZEL ~ BY: 𝙈𝙐𝙎𝙏𝘼𝙁𝘼 (@TOKYO_TEAM)  ########################
...
async def _(event):
    ...
    if input_str == "م1":
        ...
        if r == 0:
            await event.edit(
                "𓆰 [𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/TOKYO_TEAM) 𓆪\n **✘ ∫ قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤](t.me/TOKYO_TEAM) 𓆪"
            )
        else:
            await event.edit(
                "𓆰 [𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/TOKYO_TEAM) 𓆪\n **✘ ∫ قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤](t.me/TOKYO_TEAM) 𓆪"
...
########################  SOURCE 𝙏𝙤𝙠𝙔𝙤 ~ BY: 𝙈𝙐𝙎𝙏𝘼𝙁𝘼 (@TOKYO_TEAM)  ########################
...
########################  𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤 ~ BY: 𝙈𝙐𝙎𝙏𝘼𝙁𝘼 (@MFMVIP)  ########################
...
async def _(MFM):
    await eor(MFM, "𓆰 [𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤 - 𝑩𝑳𝑨𝑪𝑲𝑳𝑰𝑺𝑻](t.me/TOKYO_TEAM) 𓆪\n **✘ ∫ القائمة السوداء :** \n⪼ `.منع كلمه + الكلمه ` لمنع كلمه  \n⪼ `.الغاء منع + الكلمه` \n⪼ `.الكلمات المحظوره` \n⪼ `.ازعاج` \n⪼ `.الغاء ازعاج` \n⪼ `.قائمة الازعاج` \n 𓆩 [𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤](t.me/TOKYO_TEAM) 𓆪")
...
async def _(MFM):
    await eor(MFM, "𓆰 [𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤 - 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹](t.me/TOKYO_TEAM) 🧸♥️𓆪\n**ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷**\n **𓄂༒** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹  ↬ @MFMVIP ༗")
