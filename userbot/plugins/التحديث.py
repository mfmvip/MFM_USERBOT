...
async def deploy(event, repo, ups_rem, ac_br, txt):
    if HEROKU_API_KEY is not None:
        ...
        if heroku_app is None:
            await event.edit(f"{txt}\n" "بيانات اعتماد هيروكو غير صالحة لتنصيب طوكيو")
            return repo.__del__()
        await event.edit(
...
async def upstream(event):
    "بالنسبة لأمر التحديث ، تحقق مما إذا كان بوت طوكيو محدثًا ، أو قم بالتحديث إذا تم بتحديثه"
