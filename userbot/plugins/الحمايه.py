...
ICSS_PIC = (
    PMPERMIT_PIC
    if PMPERMIT_PIC
    else "https://telegra.ph/file/967209504b62689f5f770.jpg"
)
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "MFMbot"
...
@icssbot.on(events.NewMessage(incoming=True, from_users=(911945965)))
