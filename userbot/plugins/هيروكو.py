...
Heroku_cmd = (
    ...
    "⪼ `.استخدامي` \n"
    "ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷\n"
    "𓆩 𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤  - [𝘿𝙀𝙑](t.me/TOKYO_TEAM) 𓆪"
)
...
async def _(dyno):
    ...
    try:
        ...
        return await dyno.reply(
            "**- عذرا لا يمكنك استخدام اوامر الفارات وهيروكو الا بعد اضافة كود هيروكو الى الفارات شرح الاضافة [اضغط هنا](https://t.me/MFM_Thon)**"
        )
    data = app.get_log()
    key = (
